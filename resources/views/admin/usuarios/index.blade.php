                            ...
                            <tbody style="text-align: center;">
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center" style="gap: 5px;">
                                        <a href="{{url('/admin/usuario/'.$usuario->id)}}" class="btn btn-info btn-sm" title="DETALLES"><i class="fas fa-eye"></i> DETALLES</a>
                                        <a href="{{url('/admin/usuario/'.$usuario->id.'/edit')}}" class="btn btn-success btn-sm" title="EDITAR"><i class="fas fa-edit"></i> EDITAR</a>
